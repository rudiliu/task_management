...
class Pagination{
	...
	function getAJAXlink( $count, $text) {
        if( $this->contentDiv == '')
            return '<a id="task-list-page-'.$count.'" href="'. $this->anchorClass . ' ' . $this->baseURL . $count . '">'. $text .'</a>';
        $pageCount = $count?$count:0;
		
	    return "<a id='task-list-page-".$count."'  href=\"javascript:void(0);\" " . $this->anchorClass . "
				onclick=\"custom_task_list($pageCount,'$this->filterStatus')\">"
			   . $text .'</a>';
	}
